import { Modal, StyleSheet, Text, TouchableOpacity, View, Switch, Keyboard, FlatList } from 'react-native'
...
useEffect(()=>{
  ...
  return (
    <View style={styles.container}>
      ...
      style={[styles.floatingButton,{left:0,backgroundColor:"green",width:50}]}>
        <Text>refresh</Text>
      </TouchableOpacity>
      ...
      renderItem={({item}:{item:{groupName:string,id:number}})=>{
        return(
          ...
          style={{padding:10,borderWidth:1,borderColor:'black',margin:5}}>
  ...
  <View style={styles.modalContainer}>
    <View style={styles.modalContent}>
      ...
      <View style={styles.switchContainer}>
        <Text style={styles.switchLabel}>Group Type: {!isOpenGroup ? 'Open' : 'Close'}</Text>
        <Switch
          value={isOpenGroup}
